...
$(document).ready(function(){
  ...
  $("#texto").text("Hola bienvenido a esta lección, interectúa con mAPImundo y descubre nuevas cosas acerca de los continentes. Presta mucha atención a todo ya que lo necesitarás para pasar al siguiente nivel");
  ...
  function()
  {
    hablar("Hola bienvenido esta es tu primera lección, interactúa con mApiMundo y descubre nuevas cosas acerca de los continentes. Presta mucha atención a todo, ya que lo necesitarás para pasar al siguiente nivel");
  }, 7000);
...
*/
  ...
  $("#listo").click(function(){
    ...
    $("#aceptar1").show();
    $("#listo").hide();
    $("#texto").text("¿Estás preparado?. ¿Puedes identificar a los continentes en los que se divide la tierra?");
    hablar("Al parecer estás listo, Vamos a ver si logras identificar a los continentes en los que se divide la tierra");
  });
...
*/
        ...
        //getWikipedia();
      $("#texto").text("Ahora vamos a ver que tanto conoces y aprendiste de estos continentes. Lee (escucha) los siguientes textos y selecciona el continente del que se trata.");
      hablar("Ahora vamos a ver que tanto conoces y aprendiste de estos continentes. Lee (escucha) los siguientes textos y selecciona el continente del que se trata.");
      ...
      $("#texto").empty();
        $("#pais").text("Resultados");
      $("#imagen").html("<h3>Tus resultados de esta lección son los siguientes:</h3><br/>"+
      "<h3>Ubicar a los continentes: " + porcentaje_Conti+ "</h3>"+
      "<h3>Preguntas sobre continentes: " + porcentaje_Pregun+ "</h3>"+
      "<h3>Calificación final:" + calificacion+ "</h3>");
      console.log(calificacion);
      if(calificacion==10){
        hablar("Felicidades "+$("#user").text() +" has terminado la primer lección con un desempeño excelente.");
      }else if(calificacion>=8 && calificacion<10){
        hablar("Muy bien "+$("#user").text() +" has terminado la primer lección con un desempeño bueno.");
      }else if(calificacion>=6 && calificacion<8){
        hablar("Muy bien "+$("#user").text() +" has terminado la primer lección con un desempeño aceptable.");
      }else if(calificacion<6){
        hablar("¡Rayos! no has logrado pasar este nivel. "+$("#user").text() +" vuelve a intentarlo y presta más atención.");
      }
...
var evaluarRespuesta = function(valor,arreglo, contador){
  ...
  function()
  {
   ...
   if(contador<10){
    ...
    termino2=true;
    //alert("Terminaste");
    hablar("Muy bien "+$("#user").text() +"  has terminado la lección 1. Presiona siguiente para ver tus resultados");
    $("#texto").text("Muy bien "+$("#user").text() +"  has terminado la lección 1. Presiona siguiente para ver tus resultados");
...
var evalua = function(valor){
  if(valor === "nada"){
    hablar($("#user").text() +" intenta seleccionar un continente."); 
  }else if(valor === "fallaste"){
    hablar( $("#user").text() +" fallaste, inténtalo una vez más"); 
  }
    ...
    if(valor === ""){
     $("#texto").text("¡BIEN! "+$("#user").text() +"  ¿Ahora puedes ubicar y seleccionar al continente Europeo?");
    ...
    if(valor !==""){
     identificaContinentes(valor,"Africa");
  	...
  	if(valor === ""){
     $("#texto").text("¡¡EXCELENTE "+$("#user").text() +" !! Ahora intenta ubicar y seleccionar al continente Asiático");
    hablar("¡¡EXCELENTE!! Ahora intenta ubicar y seleccionar al continente Asiático");
    }
    ...
    if(valor !==""){
     identificaContinentes(valor,"Asia");
  	...
  	if(valor === ""){
     $("#texto").text("¡¡PERFECTO!! ¿Puedes hacer una más? Ubica y selecciona a Oceanía");
    hablar("¡¡PERFECTO!! ¿Puedes hacer una más? Ubica y selecciona a Oceanía");
    }
   ...
   $("#imagen").empty();
   $("#texto").text("Muy bien "+$("#user").text() +"  has terminado la primer parte. Ahora vamos a ver que tanto conoces y aprendiste de estos continentes. Lee (escucha) los siguientes textos y selecciona el continente del que se habla.");
